...
const envVars = [
  ...
  envVar("RESCUE_JOURNAL_DIR", process.env.RESCUE_JOURNAL_DIR || "/var/data/ember/rescues"),
  envVar("PAYDAY_JOURNAL_DIR", process.env.PAYDAY_JOURNAL_DIR || "/var/data/ember/payday"),
